...
import net.bonsaistudios.endermanoverhaul.client.model.armor.HoodArmorModel;
import net.bonsaistudios.endermanoverhaul.common.item.HoodArmorItem;
import net.bonsaistudios.endermanoverhaul.common.item.ModArmorMaterials;
import net.bonsaistudios.endermanoverhaul.common.item.TinySkullItem;
